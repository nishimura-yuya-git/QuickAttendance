      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="mb-6">
              この利用規約（以下「本規約」といいます）は、株式会社Lean Stack（以下「当社」といいます）が提供する勤怠管理サービス「サクッと勤怠」（以下「本サービス」といいます）の利用条件を定めるものです。本サービスの利用者（以下「ユーザー」といいます）は、本規約に同意した上で本サービスを利用するものとします。
            </p>
